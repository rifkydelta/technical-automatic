...
from models.response import SignalScanResponse, SignalRow, SignalStatsResponse
...
async def get_signal_stats():
    ...
    try:
        ...
        return SignalStatsResponse(
            ...
            buy_count=stats.get("buy_count") or 0,
            sell_count=stats.get("sell_count") or 0,
            avg_winrate=round(float(stats.get("avg_winrate") or 0.0), 2),
