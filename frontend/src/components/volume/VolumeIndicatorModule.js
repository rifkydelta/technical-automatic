...
import VolumeChapter from './VolumeChapter';

const CHAPTERS = [
  { id: 1, title: 'Mengenal Volume' },
  { id: 2, title: 'Cara Membaca Volume' },
  { id: 3, title: 'Volume pada Trend' },
  { id: 4, title: 'Volume pada Breakout & Breakdown' },
  { id: 5, title: 'Volume pada Chart Pattern' },
  { id: 6, title: 'Menentukan Volume Besar & Kecil' },
  { id: 7, title: 'Summary' }
];

export default function VolumeIndicatorModule() {
  ...
  if (currentChapter === 0) {
    return <VolumeOverview onStart={() => setCurrentChapter(1)} />;
  }
      ...
      <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start' }}>
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
          <div style={{ minHeight: '50vh' }}>
            <VolumeChapter chapterId={currentChapter} />
          </div>
